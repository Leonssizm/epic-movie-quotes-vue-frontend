  ...
  <div class="flex flex-col items-center mt-10 text-[#FFFFFF]">
    <div class="flex flex-col">
      <div class="relative">
        ...
        <Field
          type="text"
          class="border border-gray-500 bg-[#000000] lg:w-[56rem] h-[2rem] w-[22rem] pl-24 rounded"
    ...
    <div class="flex flex-col">
      <div class="relative mt-8">
        ...
        <Field
          type="text"
          class="border border-gray-500 bg-[#000000] lg:w-[56rem] h-[2rem] w-[22rem] pl-36 rounded"
