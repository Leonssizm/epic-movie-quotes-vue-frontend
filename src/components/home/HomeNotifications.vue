<template>
  <div class="absolute top-0 right-0 bottom-0 lg:mr-11 mt-14 flex flex-col items-end">
    <IconTriangle class="mr-3 lg:mr-[12.45rem]" />
    <div class="px-4 bg-[#000000] h-2/3 lg:w-[60rem] w-[25rem]">
          ...
          <div class="flex py-5">
            ...
            <div class="flex flex-col ml-4">
              ...
              <div v-else class="flex mt-2">
                <IconCitation />
                <p class="text-[#CED4DA] font-helvetica-neue ml-2">commented to your movie quote</p>
              </div>
